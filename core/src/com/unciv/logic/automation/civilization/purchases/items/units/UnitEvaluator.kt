...
import com.unciv.models.ruleset.UnitType
...
object UnitEvaluator {
     ...
     */
    fun determineUnitToPurchase(city: City, personality: Personality): UnitType? {
     ...
     */
    private fun evaluateUnitValue(unit: UnitType, personality: Personality): Int {
