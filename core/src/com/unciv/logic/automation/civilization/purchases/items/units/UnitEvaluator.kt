...
object UnitEvaluator {
     ...
     */
    fun determineUnitToPurchase(city: City, personality: Personality): Unit        // Get available units that can be purchased
     ...
     */
    private fun evaluateUnitValue(unit: Unitrsonality: Personality): Int {
